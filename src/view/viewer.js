...
(function (root) {
  ...
  function frame() {
    ...
    var z = Math.min(view.dpr || 1, w / span, h / (I.K * 6.5));
    g.setTransform(z, 0, 0, z, Math.round(w / 2 - c.x * z), Math.round(h / 2 - (c.y - I.K * 1.2) * z));
  ...
  function mount() {
    ...
    cv.addEventListener('click', function () { fire(); });
