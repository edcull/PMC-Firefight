...
(function () {
  ...
  /* ---------- replay.js: what happened, played out ----------
  ...
  var REPLAY = window.PMCReplay({
    ...
    get pushRes() { return pushRes; }, get queueBake() { return queueBake; },
    get render() { return render; }, get repaintTerrain() { return repaintTerrain; },
    get scheduleReturn() { return scheduleReturn; }, get setHint() { return setHint; },
