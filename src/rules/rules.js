...
(function (root) {
  ...
  var TERRAIN = {
    ...
    /* The barren table's impassable ground (p. 47), as a desert or an arctic
       world has it. A mesa is high rock: nobody climbs it and nobody sees past
       it. An ice ravine is a hole: nobody crosses, everyone sees over. */
    mesa:      { name: 'Mesa',        blocks: true,  impassable: true,  movePenalty: 0, cover: 0, fp: 0 },
  ...
  var SHAPED = { woods: 1, crater: 1, rocks: 1, water: 1, deep: 1, lava: 1, mesa: 1, ravine: 1, hill: 1 };
