...
(function (root) {
  ...
  var ROLES = {
    ...
    // the enlightened: a mix of tan and olive, one RPG among them
    holy3: ['enlight', 'enlightrpg', 'enlight2', 'enlight', 'enlight2', 'enlight'],
    // the mujahideen: all in olive, every man with a sash in the side's colour
  ...
  var KIT = {
    ...
    enlightrpg: { helm: 'turban', gun: 'rpg', armband: 'force', pack: 'none', tunic: true, wrap: '#1c1c1e', vest: '#22241e', tint: HOLY_B },
    ...
    mujlead: { helm: 'turban', gun: 'battlerifle', armband: 'force', pack: 'std', tunic: true, wrap: '#141416', vest: '#1c1e18', sash: 'force', facewrap: true, mark: true, bulk: 1, tint: HOLY_B },
    mujsaw: { helm: 'turban', gun: 'saw', armband: 'force', pack: 'ammo', tunic: true, wrap: '#141416', vest: '#1c1e18', facewrap: true, sash: 'force', bandolier: true, bulk: 1, tint: HOLY_B },
    mujrpg: { helm: 'turban', gun: 'rpg', armband: 'force', pack: 'none', tunic: true, wrap: '#141416', vest: '#1c1e18', facewrap: true, sash: 'force', tint: HOLY_B },
    muj: { helm: 'turban', gun: 'battlerifle', armband: 'force', pack: 'std', tunic: true, wrap: '#141416', vest: '#1c1e18', sash: 'force', facewrap: true, bandolier: true, tint: HOLY_B },
