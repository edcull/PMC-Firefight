...
(function (root) {
  ...
  var MOUNTS = {
    ...
    horse: { name: 'Horse', linear: true, shotSP: 1,
      note: 'Can cross linear terrain, but takes 1 extra Suppression point whenever it is hit by shooting.' }
  };
  ...
  function shoot(state, a, t, mode, opts) {
    ...
    if (hits > 0) {
      ...
      if (supp) res.sp += 2;
      // a horse shies under fire: one more Suppression point (Appendix 3)
      var mtS = mountOf(t);
