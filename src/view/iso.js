...
(function (root) {
  ...
  var ROLES = {
    ...
    leaderhuge: ['lead5', 'flaghuge', 'lead3', 'guardrifle'],
  ...
  var KIT = {
    ...
    lead4: { helm: 'turban', gun: 'none', armband: 'force', pack: 'none', tunic: true, wrap: '#f6f4ee', vest: '#22241e', sash: 'force', mark: true, bulk: 1, tint: HOLY_B },
