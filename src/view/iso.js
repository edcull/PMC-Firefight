...
(function (root) {
  ...
  var KIT = {
    ...
    drsmg: { helm: 'bot', gun: 'smg', pack: 'none', tint: DRONE_GREY, forcePad: true, robot: true },
    drshotgun: { helm: 'bot', gun: 'shotgun', pack: 'none', tint: DRONE_GREY, forcePad: true, robot: true },
    drscout: { helm: 'bot', gun: 'optics', pack: 'dish', tint: DRONE_GREY, forcePad: true, robot: true, kneel: true },
    drscoutsmg: { helm: 'bot', gun: 'smg', pack: 'none', tint: DRONE_GREY, forcePad: true, robot: true },
    drbreacher: { helm: 'bot', gun: 'shotgun', pack: 'charges', tint: DRONE_GREY, forcePad: true, robot: true },
    drsapper: { helm: 'bot', gun: 'lascutter', pack: 'charges', tint: DRONE_GREY, forcePad: true, robot: true },
    drheavy: { helm: 'bot', gun: 'heavy', pack: 'none', tint: DRONE_GREY, forcePad: true, robot: true, bulk: 1 },
  ...
  function paintFigure(g, ox, oy, pal, kit, pose, step, s) {
    ...
    if (kit.forcePad) {
      // drones: the right shoulder plate alone in the company's colour
      var fpc = vividHex(pal.forceMid || PALETTE_FORCE(pal), 3, 1.25);
      P(tx + tw - 4, -42 + drop, 7 + b, 4.5, fpc);
      P(tx + tw - 4, -42 + drop, 7 + b, 1, 'rgba(255,255,255,.35)');
      P(tx + tw - 4, -38.3 + drop, 7 + b, 0.8, 'rgba(0,0,0,.35)');
    }
