...
(function (root) {
  ...
  function paintFigure(g, ox, oy, pal, kit, pose, step, s) {
    ...
    if (kit.armband === 'force') {
      ...
      if (pal.isRebel) abc = vividHex(pal.forceMid || abc, 3, 1.3);   // a rebel's armband is the brightest thing on him
  ...
  root.PMCIso = {
    ...
    casualtySpot: casualtySpot, drawBody: drawBody, drawWreck: drawWreck, wreckFire: wreckFire
  };
})(window);
