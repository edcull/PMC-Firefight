...
(function (root) {
  ...
  // and the rest of what irregulars turn up in: grey work clothes, brown leather, faded denim, rust
  var IRR_GREY = { light: '#9a9c98', mid: '#737571', dark: '#383a37', helm: '#5c5e5a', cloth: '#6a5a44' };
  var IRR_BROWN = { light: '#9a7a5a', mid: '#745a40', dark: '#3a2c1e', helm: '#5a4630', cloth: '#6e7a58' };
  var IRR_DENIM = { light: '#7e8ea4', mid: '#5c6a80', dark: '#2e3644', helm: '#4a5466', cloth: '#8a7654' };
  var IRR_RUST = { light: '#a8704e', mid: '#824f34', dark: '#42281a', helm: '#6a4430', cloth: '#56603e' };
  ...
  var ROLES = {
    ...
    recruit: ['recruit'],
    enforcer: ['riot'],
    // eight of them, and no two dressed or armed alike
    irregular: ['irregular', 'irregular2', 'irregular3', 'irregular4', 'irregular5', 'irregular6', 'irregular7', 'irregular8'],
    penal: ['convict'],
  ...
  var KIT = {
    ...
    irregular4: { helm: 'cap', gun: 'shotgun', pack: 'none', light: true, tint: IRR_GREY },
    irregular5: { helm: 'bare', gun: 'huntingrifle', pack: 'none', light: true, bandolier: true, tint: IRR_BROWN },
    irregular6: { helm: 'balaclava', gun: 'smg', pack: 'none', light: true, tint: IRR_DENIM },
    irregular7: { helm: 'beret', gun: 'carbine', pack: 'std', light: true, tint: IRR_RUST },
    irregular8: { helm: 'hood', gun: 'battlerifle', pack: 'none', light: true, bandolier: true, tint: IRR_OLIVE },
