        ...
        case 'hawk': case 'chinook': case 'chinookcp': {
          ...
          part(off, 0, function () {
            ...
            if (st === 'chinookcp') {
              ...
              // a big radar radome slung under the nose and pushing out ahead of it, in dark grey
              // the radome joins the underside of the nose and bulges out ahead of it
              var nd = S3(AF(L * 0.46, 0), z + H * 0.14), nd2 = S3(AF(L * 0.56, 0), z + H * 0.1);
